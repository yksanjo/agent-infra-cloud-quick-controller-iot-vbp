# agent-infra-cloud-quick-controller-iot-vbp

## Detailed Description

agent-infra-cloud-quick-controller-iot-vbp is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
